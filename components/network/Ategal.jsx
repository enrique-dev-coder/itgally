        ...
        <NetworkModal title="Ategal" modalClass="w-full border pb-[3rem] h-[450px] overflow-scroll" >
            <div className="flex flex-col col-span-2 lg:col-span-1 mt-[2rem] gap-[2rem] px-[2.5rem]">
                ...
                <p className="hidden lg:block text-primary-violet">
                    ...
                    <a href="https://www.ategal.com" target="_blank" rel="noopener noreferrer">www.ategal.com</a>
                </p>
            </div>

            <video src="https://res.cloudinary.com/datsipxkz/video/upload/v1651767246/itgall/ategal_ujclfb.mp4" className=" w-4/5 shadow-2xl col-span-2 lg:col-span-1 mt-[2rem]" controls autoPlay></video>
