...
const Saraiva = () => {
    return (
        <NetworkModal title="Saraiva" modalClass="w-full border pb-[3rem] h-[450px] overflow-scroll">
            ...
            <video src="https://res.cloudinary.com/datsipxkz/video/upload/v1651767257/itgall/Saraiva_mnhyji.mp4" className=" w-4/5 shadow-2xl col-span-2 lg:col-span-1 m-auto" controls autoPlay></video>
