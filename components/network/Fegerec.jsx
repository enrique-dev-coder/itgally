...
const Fegerec = () => {
    return (
        <NetworkModal title="Fegerec" modalClass="w-full border pb-[3rem] h-[450px] overflow-scroll" >
            ...
            <video src="https://res.cloudinary.com/datsipxkz/video/upload/v1651767244/itgall/Fegerec_jx8fy6.mp4" className=" w-4/5 shadow-2xl col-span-2 lg:col-span-1 m-auto" controls autoPlay></video>
