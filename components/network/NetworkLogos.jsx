    ...
    return (
        <Fragment>
            ...
            {/* A CORUÑA */}
            {
                city.coruna &&
                <Fragment>
                        <div className={`flex gap-3 items-center cursor-pointer overflow-hidden overflow-x-auto scrollbar py-[1.5rem]`} id='logo'>
                            ...
                            <div className="shrink-0 w-[135px] h-[60px] cursor-pointer" onClick={() => setNetwork({
                                afaga: false,
                                ategal: false,
                                atendo: false,
                                cruz: false,
                            ...
                            <div className="shrink-0 w-[120px] h-[66px] cursor-pointer" onClick={() => setNetwork({
                                afaga: false,
                                ategal: false,
                                atendo: false,
                                cruz: false,
            ...
            {/* VIGO */}
            {
                city.vigo &&
                <Fragment>
                    <div className={`flex gap-3 items-center overflow-hidden overflow-x-auto scrollbar py-[1.5rem]`} id='logo'>

                        <div className="shrink-0 w-[120px] h-[64px] cursor-pointer" onClick={() => setNetwork({
                            afaga: true,
                            ategal: false,
                            atendo: false,
                            cruz: false,
                        ...
                        <div className="shrink-0 w-[123px] h-[60px] cursor-pointer" onClick={() => setNetwork({
                            afaga: false,
                            ategal: false,
                            atendo: true,
                            cruz: false,
            ...
            {/* GALICIA */}
            {
                city.galicia &&
                <Fragment>
                    <div className={`w-full flex items-center overflow-hidden overflow-x-auto py-[1.5rem] scrollbar`} id='logo'>
                        <div className="shrink-0 mx-[.5rem] w-[120px] h-[64px] cursor-pointer" onClick={() => setNetwork({
                            afaga: true,
                            ategal: false,
                            atendo: false,
