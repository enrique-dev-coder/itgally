const NetworkMap = ({city, setBtnControl, setCity, setNetwork}) => {
    ...
    return (
        <svg className="absolute -left-[50%] sm:-left-[35%] md:left-0 w-[700px] md:w-[1000px] fill-slate-300 " baseProfile="tiny" stroke="#ffffff" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" version="1.2" viewBox="0 0 1000 891" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* LUGO */}
            <path className={`${city.galicia || city.lugo ? "fill-slate-800" : "fill-[#C680B3]"} hover:fill-slate-800 transition ease-in-out duration-150 cursor-pointer`} onClick={() => {
                setBtnControl(false)
                setCity({
                    coruna: false,
                    galicia: true,
            ...
            {/* OURENSE */}
            <path className={`${city.galicia || city.ourense ? "fill-slate-800" : "fill-[#C680B3]"} hover:fill-slate-800 transition ease-in-out duration-150 cursor-pointer`} onClick={() => {
                setBtnControl(false)
                setCity({
                    coruna: false,
                    galicia: false,
